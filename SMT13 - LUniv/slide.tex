...
\date[SMT 2013]{SMT Workshop, 2013}
...
\begin{frame}{Why compressing propositional part of SMT proofs?}
  \begin{subpart}{SMT solvers are embeded in other tools}
    \item Sledgehammer's extension to SMT solver
    \item SMTCoq
  \end{subpart}
  \begin{subpart}{Some tools need the proof to be}
    \item checked;
    \item tranlated;
    \item analysed.
  \end{subpart}
...
\begin{frame}{Resolution}
  ...
  \begin{block}
    \centering
    \tikzstyle{ndist}=[node distance=1.2cm]
    \newcommand{\ru}{$\dual{b}$}
    \newcommand{\au}{$b \dual{a}$}
    \newcommand{\lo}{$a$}
    \newcommand{\rd}{$b c$}
    \newcommand{\ad}{$\dual{a} b c$}
    \tikz[baseline=(r1.north), ndist]{
      \proofnode {r1} {\ru};
      \withchildren{r1} {a1}{\au} {low}{\lo};
    }  $\odot_{\dual{c}}$ \tikz[baseline=(r2.north), ndist]{
      \proofnode {r2}{\rd};
      \withchildren{r2} {low}{\lo} {a2}{\ad};
    } = \tikz[baseline=(r1.base), ndist]{
      \proofnode {r0} {$c$};
      \withchildren{r0} {r1}{\ru} {r2}{\rd};
      \withchildren{r1} {a1}{\au} {low}{\lo};
      \proofnode[above right of=r2] {a2} {\ad};
      \drawchildren {r2} {low} {a2};
    }
  \end{block}
...
\begin{frame}
  ...
  \begin{subpart}{Future works}
    ...
    \item Lower subproofs to the middle of the proof.
    \item Explore other kinds of redundancies.
  \end{subpart}
\end{frame}
